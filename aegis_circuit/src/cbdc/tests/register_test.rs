mod register_tests {
    ...
    lazy_static! {
        pub static ref PK_FILE: String = "register.pk.dat".to_string();
        pub static ref VK_FILE: String = "register.vk.dat".to_string();
        pub static ref PK_UNCOMP_FILE: String = "register.pk.uncompressed.dat".to_string();
        pub static ref VK_UNCOMP_FILE: String = "register.vk.uncompressed.dat".to_string();
        pub static ref PRF_FILE: String = "register.proof.dat".to_string();
    }
    ...
    fn test_make_pk_vk_size() {
        ...
        println!("Generate register circuit test input!");

        let test_input =
            <RegisterCircuit<C, GG> as MockingCircuit<C, GG>>::generate_circuit(TREE_HEIGHT)
                .unwrap();
    ...
    fn test_setup_and_proving_time() {
        ...
        image.append(&mut vec![
            test_input.instance.cm.clone().unwrap(),
            ...
            test_input.instance.ct_bar.clone().unwrap()[6],
